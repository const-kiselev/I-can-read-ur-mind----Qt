...
#include "../src/widgets/menu/menu.h"
...
QT_MOC_LITERAL(1, 5, 14), // "signalsHandler"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "Menu\0signalsHandler\0"
};
...
void Menu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->signalsHandler((*reinterpret_cast< const QString(*)>(_a[1])));
